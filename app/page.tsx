...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #fff5f6 0%, #f0fafa 50%, #fffbf0 100%)" }}>
      {/* Header */}
      <header style={{
        background: "white",
        ...
        boxShadow: "0 2px 12px rgba(232,86,106,0.08)"
      }}>
      ...
      {/* Tab Bar */}
      <div style={{ background: "white", borderBottom: "1px solid #f0e6e8" }}>
